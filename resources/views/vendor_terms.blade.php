...
<head>
    ...
    <title>Vendor Terms & Conditions - Yaan Partner App</title>
...
<body>
    ...
    <div class="header-bg">
        <div class="brand-badge">🏨 Yaan Partner App</div>
        <h1>Vendor Terms & Conditions</h1>
        <p>For Registered Hotel & Dhaba Partners</p>
    </div>

    <div class="container">
        <!-- Switch Tabs -->
        <div class="nav-tabs">
            <a href="/vendor/terms-and-conditions" class="nav-tab active">🏨 Vendor Terms</a>
            <a href="/vendor/privacy-policy" class="nav-tab">🛡️ Vendor Privacy</a>
            <a href="/terms-and-conditions" class="nav-tab">🚚 Customer Terms</a>
            <a href="/privacy-policy" class="nav-tab">🔒 Customer Privacy</a>
        </div>
        ...
        <div class="card">
            ...
            <div class="meta-box">
                ...
                <div class="meta-item"><strong>Target Audience:</strong> {{ $data['target_audience'] }}</div>
                ...
                <div class="section-item">
                    ...
                    @if(isset($section['contact']))
                        <div class="contact-box">
                            <h3>Partner Support & Legal Contact</h3>
                            ...
                            <p style="margin-bottom: 6px;"><strong>Jurisdiction:</strong> {{ $section['contact']['address'] }}</p>
                        </div>
                    @endif
                </div>
            @endforeach

...
<head>
    ...
    <title>Contact Us - Yaan App</title>
...
<body>
    ...
    <div class="header-bg">
        <div class="brand-badge">📞 Yaan Support</div>
        <h1>Contact Us & Help Support</h1>
        <p>We are here 24/7 to assist truck drivers and hotel partners</p>
    </div>

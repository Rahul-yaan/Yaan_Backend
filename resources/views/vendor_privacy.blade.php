...
<head>
    ...
    <title>Vendor Privacy Policy - Yaan Partner App</title>
...
<body>
    ...
    <div class="header-bg">
        <div class="brand-badge">🛡️ Yaan Partner Privacy</div>
        <h1>Vendor Privacy Policy</h1>
        <p>Partner Data Protection & Compliance Policy</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="nav-tabs">
            ...
            <a href="/vendor/privacy-policy" class="nav-tab active">🛡️ Vendor Privacy</a>
                ...
                <div class="section-item">
                    ...
                    @if(isset($section['contact']))
                        <div class="contact-box">
                            <h3>Contact Us regarding Partner Privacy</h3>

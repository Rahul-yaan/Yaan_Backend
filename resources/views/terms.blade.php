...
<head>
    ...
    <title>Terms & Conditions - Yaan App</title>
...
<body>
    ...
    <div class="header-bg">
        <div class="brand-badge">🚚 Yaan App</div>
        <h1>Terms & Conditions</h1>
        <p>For Customers & Truck Drivers</p>
    </div>

    <div class="container">
        <!-- Switch Tabs -->
        <div class="nav-tabs">
            <a href="/terms-and-conditions" class="nav-tab active">🚚 Customer Terms</a>
            ...
            @foreach($data['sections'] as $section)
                <div class="section-item">
                    ...
                    @if(isset($section['footer']))
                        <p class="section-text" style="margin-top: 10px;">{{ $section['footer'] }}</p>
                    @endif
